...
import { listChannels, listThreads, listRepos, createThread, createChannel, searchMessages, listPrincipals, listDms, startDm, approveRun, declineRun, runDiff, syncPrComments, approvePlan, rejectPlan } from "./api.js";
...
function ThreadConversation({ threadId }: { threadId: string }) {
  ...
  return (
    <>
      <ThreadView messages={messages} onApprove={onApprove} onDecline={onDecline} onLoadDiff={onLoadDiff} onSyncComments={onSyncComments} onApprovePlan={onApprovePlan} onRejectPlan={onRejectPlan} />
